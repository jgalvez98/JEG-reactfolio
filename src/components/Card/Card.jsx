		...
		<div className="container">
          ...
          <h1>My Projects</h1>
			...
			<div className="row d-flex justify-content-center" >
				...
				<div className="card">
					<img src="/public/weatherapp.png" className="card-img" alt="weather forecast" />
				...
				<div className="card">
					<img src="/public/recipeasy.png" className="card-img" alt="recipeasy" />
					<div className="card-body">
				...
				<div className="card">
					<img src="/public/cruisecontrol.png" className="card-img" alt="cruise planner" />
					<div className="card-body">
				...
				<div className="card">
					<img src="/public/texteditor.png" className="card-img" alt="text editor" />
					<div className="card-body">
				...
				<div className="card">
					<img src="/public/workscheduler.png" className="card-img" alt="scheduler" />
					<div className="card-body">
